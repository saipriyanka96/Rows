package com.example.layout.rows;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        lt= (ListView)findViewById(R.id.listview);//creating the listview
        lt.setAdapter(new MyAdapter(this));//creating Adapter object
    ...
    class MyAdapter extends BaseAdapter {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            SingleRow tep= list.get(position);//get's the position
            name.setText(tep.Name);//printing them
